/********
* ec2c version 0.67
* c main file generated for node : modulo_n_clock 
* to be used with : modulo_n_clock.c 
* and             : modulo_n_clock.h 
* context   method = HEAP
...
/* Output procedures **********************/
#ifdef CKCHECK
void modulo_n_clock_BOT_max_modulo(void* cdata){
   _put_bottom("max_modulo");
}
void modulo_n_clock_BOT_nombre(void* cdata){
   _put_bottom("nombre");
}
#endif
/* Output procedures **********************/
void modulo_n_clock_O_max_modulo(void* cdata, _integer _V) {
   _put_int("max_modulo", _V);
}
void modulo_n_clock_O_nombre(void* cdata, _integer _V) {
   _put_int("nombre", _V);
}/* Main procedure *************************/
int main(){
   ...
   int s = 0;
   /* Context allocation */
   struct modulo_n_clock_ctx* ctx = modulo_n_clock_new_ctx(NULL);
   ...
   while(1){
      ...
      fflush(stdout);
      ++s;
      modulo_n_clock_I_n(ctx, _get_int("n"));
      modulo_n_clock_step(ctx);
